...
import com.pedro.streamer.streamvideoaudio.StreamVideoAudioActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createList() {
        ...
        activities.add(
            ActivityLink(
                Intent(this, StreamVideoAudioActivity::class.java),
                getString(R.string.stream_with_video_and_audio), VERSION_CODES.LOLLIPOP
            )
        )
    }
