  ...
  public void run() {
    ...
    while (running) {
      if (frameAvailable) {
        ...
        simpleCameraRender.drawFrame(previewWidth, previewHeight, keepAspectRatio, aspectRatioMode, 0);
        ...
        synchronized (sync) {
          if (surfaceManagerEncoder != null && !fpsLimiter.limitFPS()) {
            ...
            simpleCameraRender.drawFrame(encoderWidth, encoderHeight, false, aspectRatioMode, streamRotation);
