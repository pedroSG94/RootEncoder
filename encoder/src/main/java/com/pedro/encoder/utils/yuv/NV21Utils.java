...
public class NV21Utils {
    ...
    public void clearBuffers() {
        preAllocatedBufferRotate = null;
        preAllocatedBufferColor = null;
    }

    public int[] toARGB(byte[] yuv, int width, int height) {
    ...
    public byte[] toYV12(byte[] input, int width, int height) {
        final int frameSize = width * height;
    ...
    public byte[] toNV12(byte[] input, int width, int height) {
        final int frameSize = width * height;
        final int qFrameSize = frameSize / 4;
        System.arraycopy(input, 0, preAllocatedBufferColor, 0, frameSize); // Y
        for (int i = 0; i < qFrameSize; i++) {
    ...
    public byte[] rotate90(byte[] data, int imageWidth, int imageHeight) {
        // Rotate the Y luma
        int i = 0;
    ...
    public byte[] rotate180(byte[] data, int imageWidth, int imageHeight) {
        int count = 0;
    ...
    public byte[] rotate270(byte[] data, int imageWidth, int imageHeight) {
        // Rotate the Y luma
        int i = 0;
    ...
    public byte[] rotatePixels(byte[] input, int width, int height, int rotation) {
