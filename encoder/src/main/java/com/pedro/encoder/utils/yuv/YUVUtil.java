...
public class YUVUtil {
    ...
    public YUVUtil(int len) {
        Log.d(TAG, "YUVUtil() called with: len = [" + len + "]");
        preAllocateBuffers(len);
    }

    public void preAllocateBuffers(int length) {
        nv21Utils = new NV21Utils(length);
    }


    public void clearBuffers() {
        if (nv21Utils != null) {
            nv21Utils.clearBuffers();
            nv21Utils = null;
        }
    }


    public byte[] NV21toYUV420byColor(byte[] input, int width, int height,
    ...
    public byte[] rotateNV21(byte[] data, int width, int height, int rotation) {
        switch (rotation) {
            case 0:
                return data;
            case 90:
    ...
    public byte[] YV12toYUV420byColor(byte[] input, int width, int height,
                                      FormatVideoEncoder formatVideoEncoder) {
        switch (formatVideoEncoder) {
            case YUV420PLANAR:
    ...
    public byte[] rotateYV12(byte[] data, int width, int height, int rotation) {
        switch (rotation) {
            case 0:
                return data;
            case 90:
    ...
    public Bitmap frameToBitmap(Frame frame, int width, int height, int orientation) {
    ...
    public byte[] ARGBtoYUV420SemiPlanar(int[] input, int width, int height) {
        /*
    ...
    public byte[] CropYuv(int src_format, byte[] src_yuv, int src_width, int src_height,
