...
public class Camera2ApiManager2 extends CameraDevice.StateCallback {
  ...
  public Camera2ApiManager2(Context context) {
    ...
    try {
      ...
      cameraDevice.createCaptureSession(listSurfaces, new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
          Camera2ApiManager2.this.cameraCaptureSession = cameraCaptureSession;
          try {
