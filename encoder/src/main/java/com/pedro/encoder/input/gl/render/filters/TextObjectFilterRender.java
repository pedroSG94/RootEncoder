...
public class TextObjectFilterRender extends BaseFilterRender {
  ...
  public void setDefaultScale(int streamWidth, int streamHeight) {
    sprite.scale(textStreamObject.getWidth() * 100 / streamWidth,
        textStreamObject.getHeight() * 100 / streamHeight);
    squareVertexWatermark.put(sprite.getTransformedVertices()).position(0);
  }
}
