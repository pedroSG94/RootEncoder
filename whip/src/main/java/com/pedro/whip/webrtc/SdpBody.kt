...
object SdpBody {
   ...
   */
  fun createOpusBody(trackAudio: Int, port: Int): String {
    val payload = RtpConstants.payloadType + trackAudio
    return "m=audio $port UDP/TLS/RTP/SAVPF ${payload}\r\n" +
            "a=mid:$trackAudio\r\n" +
            "a=sendonly\r\n" +
  ...
  fun createG711Body(trackAudio: Int, sampleRate: Int, isStereo: Boolean, port: Int): String {
  ...
  fun createAV1Body(trackVideo: Int, port: Int): String {
    val payload = RtpConstants.payloadType + trackVideo
    return "m=video $port UDP/TLS/RTP/SAVPF $payload\r\n" +
            "a=mid:$trackVideo\r\n" +
            "a=sendonly\r\n" +
  ...
  fun createH264Body(trackVideo: Int, sps: String, pps: String, port: Int): String {
    val payload = RtpConstants.payloadType + trackVideo
    return "m=video $port UDP/TLS/RTP/SAVPF $payload\r\n" +
            "a=mid:$trackVideo\r\n" +
            "a=sendonly\r\n" +
  ...
  fun createH265Body(trackVideo: Int, sps: String, pps: String, vps: String, port: Int): String {
    val payload = RtpConstants.payloadType + trackVideo
    return "m=video $port UDP/TLS/RTP/SAVPF ${payload}\r\n" +
            "a=mid:$trackVideo\r\n" +
            "a=sendonly\r\n" +
